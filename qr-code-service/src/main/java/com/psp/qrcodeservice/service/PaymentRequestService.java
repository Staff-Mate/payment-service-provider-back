...
public class PaymentRequestService {
    ...
    public ResponseEntity<?> createPaymentRequest(ServicePaymentDto servicePaymentDto) {
        ...
        ResponseEntity<String> response = restTemplate.postForEntity("http://localhost:8080/payments/", paymentRequestDto, String.class); // TODO: replace with merchantBankUrl + /payments/
        try {
