    ...
    <tr>
        <td>
            <table class = "row row-2"
                   ...
                   cellspacing = "0"
                   role = "presentation"
                   style = "mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #607d8b; background-size: auto;">
                <tbody>
                <tr>
                    <td>
                        <table class = "row-content stack"
                            ...
                            <tr>
                                <td class = "column column-1"
                                        ...
                                        <tr>
                                            <td class = "pad"
                                                ...
                                                <h1 style = "margin: 0; color: #555555; direction: ltr; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 36px; font-weight: 400; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;">
                                                    <strong>Welcome to Discash</strong></h1>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table class = "image_block block-4"
                                           width = "100%"
                                           border = "0"
                                           cellpadding = "0"
                                           cellspacing = "0"
                        ...
                        <table class = "row-content stack"
                            ...
                            <tr>
                                <td class = "column column-1"
                                    width = "100%"
                                    style = "mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-top: 0px; padding-bottom: 0px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
                                    <table class = "text_block block-1"
                                           width = "100%"
                                           border = "0"
                                           cellpadding = "0"
                                           cellspacing = "0"
                                    ...
                                    <table class = "social_block block-2"
                                           width = "100%"
                                           border = "0"
                                           cellpadding = "0"
                                           cellspacing = "0"
                                                        ...
                                                        <tr>
                                                            <td style = "padding:0 7px 0 7px;">
                                                                <a href = "https://www.facebook.com/"
                                                                   target = "_blank"><img src = "https://app-rsrc.getbee.io/public/resources/social-networks-icon-sets/circle-dark-gray/facebook@2x.png"
                                                                                          width = "32"
                                                                                          height = "32"
                                                                                          alt = "Facebook"
                                                                                          title = "Facebook"
                                                            ...
                                                            <td style = "padding:0 7px 0 7px;">
                                                                <a href = "https://twitter.com/"
                                                                   target = "_blank"><img src = "https://app-rsrc.getbee.io/public/resources/social-networks-icon-sets/circle-dark-gray/twitter@2x.png"
                                                                                          width = "32"
                                                                                          height = "32"
                                                                                          alt = "Twitter"
                                                                                          title = "Twitter"
                                                            ...
                                                            <td style = "padding:0 7px 0 7px;">
                                                                <a href = "https://instagram.com/"
                                                                   target = "_blank"><img src = "https://app-rsrc.getbee.io/public/resources/social-networks-icon-sets/circle-dark-gray/instagram@2x.png"
                                                                                          width = "32"
                                                                                          height = "32"
                                                                                          alt = "Instagram"
                                                                                          title = "Instagram"
                                    ...
                                    <table class = "image_block block-1"
                                        ...
                                        <tr>
                                            <td class = "pad"
                                                ...
                                                <div class = "alignment"
                                                     align = "center"
                                                     style = "line-height:10px"><img class = "fullMobileWidth"
                                                ...
                                                <div style = "font-family: sans-serif">
                                                    <div class = "txtTinyMce-wrapper"
                                                        ...
                                                        <p style = "margin: 0; font-size: 14px; text-align: center;">
                                                            <span style = "font-size:12px;">© 2022 Discash | 1441 2nd St SE, Mason City, Iowa(IA) 50401</span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                    ...
                                    <table class = "text_block block-3"
                                        ...
                                        <tr>
                                            <td class = "pad"
                                                ...
                                                <div style = "font-family: sans-serif">
                                                    <div class = "txtTinyMce-wrapper"
                                                         style = "font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #262b30; line-height: 1.2; font-family: Arial, Helvetica Neue, Helvetica, sans-serif;">
